...
def getOtherStat(vcfFile, tag):
    return callSys("""grep '#' -v %s |  awk -F'%s' '{print $2}' | awk -F'[=;]'
    '{print $2}' | tabtk num -c1 -Q""" % (vcfFile, tag))
...
if __name__ == '__main__':
    ...
    default = ["QUAL", "DP", "MQ"],
    help="the specifc tags, for which you want to know statistics " +
    "(mean, min, max, quantiles. defualt= [QUAL, DP, MQ]")
